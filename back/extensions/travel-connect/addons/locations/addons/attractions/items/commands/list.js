...
commands.Item({
    ...
    callback: async function(properties, resolve)
    {
        ...
        let query = locations.attractions.Find().filter('team_id', user.team.id);
        ...
        resolve({ attractions: items.map(item => item.Get(FIELDS)) });
    }
});
