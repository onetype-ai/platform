...
commands.Item({
    ...
    callback: async function(properties, resolve)
    {
        ...
        let query = directories.distances.Find().filter('team_id', user.team.id);
        ...
        resolve({ distances: items.map(item => item.Get(FIELDS)) });
    }
});
